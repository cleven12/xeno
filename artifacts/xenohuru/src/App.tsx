...
const articles: Article[] = [
  { slug: 'tourism-data-pipelines', category: 'Infrastructure', title: "Designing Tourism Data Pipelines That Don't Break", excerpt: 'A field guide to ingesting, cleaning, and serving unreliable tourism data across borders.', date: 'May 18, 2026', readTime: '8 min read', author: 'Cleven G.' },
  { slug: 'building-reliable-payment-rails', category: 'Payments', title: 'Building Reliable Payment Rails for African Operators', excerpt: 'What changes when a payment system must survive intermittent networks, multiple currencies, and real people.', date: 'May 11, 2026', readTime: '11 min read', author: 'Cleven G.' },
  ...
  { slug: 'state-of-tourism-data', category: 'Data', title: 'The State of Tourism Data in East Africa', excerpt: 'A map of the sources, gaps, and quiet infrastructure holding a region together.', date: 'Apr 25, 2026', readTime: '13 min read', author: 'Cleven G.' },
  ...
  { slug: 'offline-first-bookings', category: 'Infrastructure', title: 'The Case for Offline-First Booking Flows', excerpt: 'Designing for the two minutes when the network disappears at the exact wrong time.', date: 'Apr 12, 2026', readTime: '9 min read', author: 'Cleven G.' },
  ...
  { slug: 'mapping-the-visitor-economy', category: 'Research', title: 'Mapping the Visitor Economy', excerpt: 'What a useful map reveals when tourism is treated as an interconnected civic system.', date: 'Mar 19, 2026', readTime: '12 min read', author: 'Cleven G.' },
];
